...
// arr = [adj1, adj2, food, noun1, bodyPart, verb1, clothing];
// console.table(arr);
...
const story = `My friends and I started a secret club! we meet every day by the <b>${adj1}</b> <b>${noun1}</b>. Our club has some very special roles. If you want to join, you have to wear a <b>${adj2}</b> <b>${clothing}</b> on your <b>${bodyPart}</b>, You are not allowed to <b>${verb1}</b> during meetings, and you can only eat <b>${food}</b> for your meals. If you are intrested in joining, let me know!`;
